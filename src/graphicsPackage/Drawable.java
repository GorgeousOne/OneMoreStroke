...
public class Drawable {
	...
	public Drawable(Shape shape, Color color, int layer) {
		this.shape = shape;
		this.color = color;
		this.layer = layer;
		this.scale = 1;
	...
	//berechnet Shape neu nach Blickrichtung etc
	...
	public void setPos(Point2D pos) {this.pos.setLocation(pos.getX(), pos.getY());}
